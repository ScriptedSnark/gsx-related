...
typedef int  (*INITIALIZE_FUNC)(struct cl_enginefuncs_s* pEnginefuncs, int iVersion);
...
typedef void (*HUD_CALCREF_FUNC)(ref_params_t* pparams);
...
typedef void* (*CLIENTFACTORY)(void); // this should be CreateInterfaceFn but that means including interface.h
...
typedef void (*DST_INITIALIZE_FUNC)(struct cl_enginefuncs_s** pEnginefuncs, int* iVersion);
typedef void (*DST_HUD_INIT_FUNC)(void);
typedef void (*DST_HUD_VIDINIT_FUNC)(void);
typedef void (*DST_HUD_REDRAW_FUNC)(float*, int*);
typedef void (*DST_HUD_UPDATECLIENTDATA_FUNC)(client_data_t**, float*);
...
typedef void (*DST_HUD_CALCREF_FUNC)(ref_params_t**);
...
typedef void (*DST_HUD_CONNECTIONLESS_FUNC)(const netadr_t**, const char**, char**, int**);
...
typedef void						(*pfnEngSrc_pfnSPR_Draw_t)				(int frame, int x, int y, const wrect_t* prc);
typedef void						(*pfnEngSrc_pfnSPR_DrawHoles_t)		(int frame, int x, int y, const wrect_t* prc);
typedef void						(*pfnEngSrc_pfnSPR_DrawAdditive_t)		(int frame, int x, int y, const wrect_t* prc);
...
typedef void						(*pfnEngSrc_pfnPlaybackEvent_t)		(int flags, const edict_t* pInvoker, unsigned short eventindex, float delay, float *origin, float *angles, float fparam1, float fparam2, int iparam1, int iparam2, int bparam1, int bparam2);
...
typedef void						(*pfnEngSrc_pfnSPR_DrawGeneric_t)(int frame, int x, int y, const wrect_t* prc, int src, int dest, int w, int h);
...
typedef void	(*pfnEngDst_pfnSPR_Draw_t)				(int *, int *, int *, const wrect_t**);
typedef void	(*pfnEngDst_pfnSPR_DrawHoles_t)		(int *, int *, int *, const wrect_t**);
typedef void	(*pfnEngDst_pfnSPR_DrawAdditive_t)		(int *, int *, int *, const wrect_t**);
...
typedef void	(*pfnEngDst_pfnSetCrosshair_t)			(HSPRITE *, wrect_t*, int *, int *, int *);
...
typedef void	(*pfnEngDst_pfnPlaybackEvent_t)		(int *, const edict_t**, unsigned short *, float *, float **, float **, float *, float *, int *, int *, int *, int *);
...
typedef void	(*pfnEngDst_pfnSPR_DrawGeneric_t)		(int *, int *, int *, const wrect_t**, int *, int *, int *, int *);
